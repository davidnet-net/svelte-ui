...
<div class="blanket" tabindex="-1">
	<div class="modal" role="dialog" aria-modal="true" aria-labelledby="modal-title" aria-describedby="modal-desc" bind:this={modalRef}>
		{#if hasCloseBtn}
		...
		<div class="button-row">
			{#each options as { appearance = 'subtle', content, onClick, iconbefore, iconafter } (content)}
